...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<section class="content-header">
		<h1>
			医生管理 <small>修改信息</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="all-admin-index.html"><i
					class="fa fa-dashboard"></i> 首页</a></li>
			<li><a href="all-travellog-review-list.html">个人中心</a></li>
		</ol>
	</section>
	<!-- 内容头部 /-->
	...
	<section class="content">
		...
		<div class="nav-tabs-custom">
			...
			<ul class="nav nav-tabs">
				<li class="active"><a href="#tab-form" data-toggle="tab">基本信息</a>
				</li>
			</ul>
			<!--tab头/-->
			...
			<div class="tab-content">
				...
				<div class="tab-pane active" id="tab-form">
					<div class="row data-type">
						<form id="doctorForm" action="${pageContext.request.contextPath }/doctorSelf/saveDoctor.html" method="post" enctype="multipart/form-data">
								...
								<div class="box box-info">
									...
									<div class="box-body pad">
										<textarea id="doctorInfo" name="doctorInfo" rows="10"
											cols="80">${doctor.doctorInfo }</textarea>
									</div>
								</div>
							</div>
							...
							<div class="col-md-10 data" style="height: 100%">
								<div class="box box-info">
									...
									<!-- /.box-header -->
									<div class="box-body pad">
										<textarea id="doctorDetails" name="doctorDetails" rows="10" cols="80"></textarea>
									</div>
								</div>
							</div>
							...
							<div class="col-md-10 data text-center">
								...
								<button type="button" class="btn bg-default"
									onclick="window.location.href='${pageContext.request.contextPath}/doctor/index.html'">返回</button>
							</div>
						</form>
					</div>
