	...
	<script type="text/javascript">
		$(function(){
            ...
            if(window.parent != window){
                window.parent.location.href="${pageContext.request.contextPath}/doctor/login.html";
            }
		});
	</script>
	<style type="text/css">
...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form action="${pageContext.request.contextPath }/doctorSelf/login.html" method="post" id="doctorLoginForm">
