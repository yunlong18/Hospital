    ...
    <div class="box-body">
        ...
        <div class="nav-tabs-custom">
            ...
            <div class="tab-content">
                ...
                <form action="${pageContext.request.contextPath }/adminSelf/changePassword.html" method="post">
                    <!--表单内容-->
                        ...
                        <div class="row data-type">
                            ...
                            <div class="col-md-8 data text-center">
                                ...
                                <button type="button" class="btn bg-default"
                                    onclick="window.location.href='${pageContext.request.contextPath}/admin/index.html'">返回</button>
                            </div>
                        </div>
                    </div>
                </form>
