...
<SCRIPT type="text/javascript">
	...
	function beforeRemove(treeId, treeNode) {
		...
		if(confirm("确认删除 节点 -- " + treeNode.name + " 吗？")){
			...
			$.ajax({
				   async:false,
				   type: "POST",
				   url: "${pageContext.request.contextPath}/contentCat/deleteNodeById.action",
				   data: "id="+treeNode.id,
	...
	function beforeRename(treeId, treeNode, newName) {
		if (newName.length == 0) {
			...
			$.post("${pageContext.request.contextPath}/contentCat/editNode.action", 
	...
	function addHoverDom(treeId, treeNode) {
		...
		if (btn)
			btn.bind("click", function() {
				...
				var newNode;
				$.post("${pageContext.request.contextPath}/contentCat/addNode.action",
						data, function(data){
