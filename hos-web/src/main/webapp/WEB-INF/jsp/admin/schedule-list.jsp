					...
					<div class="table-box">
							...
							<div class="form-group form-inline">
								<div class="btn-group">
									<button type="button" class="btn btn-default" title="新建"
										onclick='location.href="${pageContext.request.contextPath }/admin/schedule-edit.html"'>
						...
						<div class="box-tools pull-right">
							<div class="has-feedback">
								<form id="myForm"
									action="${pageContext.request.contextPath}/scheduleManager/list.html"
									method="post">
